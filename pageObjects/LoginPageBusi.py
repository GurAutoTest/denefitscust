...
class LoginPageBusi:
    ...
    button_Payment_plan_xpath = "/html/body/app-root/app-layouts/mat-sidenav-container/mat-sidenav/div/mat-nav-list/div[2]/app-sidemenu[3]/mat-list-item/div/div[2]/a"
    button_Manage_contract_xpath = "/html/body/app-root/app-layouts/mat-sidenav-container/mat-sidenav/div/mat-nav-list/div[2]/app-sidemenu[3]/div/div/app-sidemenu[1]/mat-list-item/div/div[2]/a"
    button_Full_Payment_Plan_Details_xpath= "/html/body/app-root/app-layouts/mat-sidenav-container/mat-sidenav-content/main/app-contract-list/div[1]/div[2]/div[2]/app-contract-details/div/div/div[2]/mat-accordion[1]/mat-expansion-panel/mat-expansion-panel-header/span[1]/mat-panel-title"
    ...
    def clickPaymentPlan(self):
        self.driver.find_element(By.XPATH, self.button_Payment_plan_xpath).click()

    def clickManageContract(self):
        self.driver.find_element(By.XPATH, self.button_Manage_contract_xpath).click()

    def clickFullPaymentPlanDetails(self):
        self.driver.find_element(By.XPATH, self.button_Full_Payment_Plan_Details_xpath).click()
